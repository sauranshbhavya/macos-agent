> Archived MacAgent UI conventions. Consult relevant historical reasoning; current instructions are in [AGENTS.md](../../AGENTS.md). Historical relative links below were written from the repository root.
