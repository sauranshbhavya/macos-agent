...
- New persisted data must follow current encryption, retention, migration, and deletion behavior. Prefer a versioned reader over silently changing or discarding old records.
