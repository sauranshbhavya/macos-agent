...
/// What the menu-bar item shows for the state Sonny is in, decided in one place so the Sonny mark's
...
///
/// Tints are named rather than coloured here: the menu bar draws the bundled mark as a template, and
