...
extension View {
    func localDataDeletionConfirmationDialog(isPresented: Binding<Bool>, viewModel: AgentViewModel) -> some View {
        confirmationDialog(
            ...
            Text("This deletes saved routines, workspaces, clipboard history, snippets, recent artifacts, Shortcut run history, task history, Data-Sent-to-AI records, and clipboard settings. Generated files and API keys are not deleted.")
        }
    }
}
