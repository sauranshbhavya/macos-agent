...
public struct VisionCaptureEgressPolicy: Equatable, Sendable {
    ...
    /// request body of `ceil(n/3) * 4` bytes plus the prompt, which is what keeps a request under the
    /// body limits that a 12 MB request ruled out.
