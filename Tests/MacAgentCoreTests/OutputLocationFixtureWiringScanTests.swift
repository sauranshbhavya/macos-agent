...
struct OutputLocationFixtureWiringScanTests {
    /// The fixtures, scanned as a population rather than as a list — a fourteenth file fails this by
    /// arriving, not by being remembered here.
    @Test
    func everyTestConstructedAgentViewModelIsHandedItsOwnOutputLocationStore() throws {
        ...
        #expect(sitesScanned >= 14, "expected at least the 14 known construction sites, scanned \(sitesScanned)")
