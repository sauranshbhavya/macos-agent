...
struct SkillPackTests {
    ...
    func theCommittedCatalogueIsTheListTheFoundersDecided() throws {
        ...
        // 423 rows and on the running product on the other 50, and no row says `shallow` any more
        ...
        #expect(Dictionary(evidence.map { ($0, 1) }, uniquingKeysWith: +) == ["deep": 423, "site": 50])
