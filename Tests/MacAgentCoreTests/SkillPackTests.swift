...
struct SkillPackTests {
    ...
    func theCommittedCatalogueIsTheListTheFoundersDecided() throws {
        ...
        // 426 rows and on the running product on the other 47, and no row says `shallow` any more
        ...
        #expect(Dictionary(evidence.map { ($0, 1) }, uniquingKeysWith: +) == ["deep": 426, "site": 47])
