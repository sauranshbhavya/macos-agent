...
/// the reason every `AgentViewModel` fixture names its fourteen stores: the real Keychain is shared
...
/// not. **The store count stays** — it is `LocalStore.allCases.count`, fourteen since SONNY-333,
...
/// fifteenth store fails a test before it reaches a reader. The numeral was spelled here anyway and
